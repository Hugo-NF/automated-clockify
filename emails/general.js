module.exports.generalEmail = (title, startDate, endDate, senderEmail) => `
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <style>@font-face {
font-family: 'Exo 2'; font-style: normal; font-weight: 400; font-display: swap; src: url(https://fonts.gstatic.com/s/exo2/v10/7cH1v4okm5zmbvwkAx_sfcEuiD8jvvKcPg.ttf) format('truetype');
}
@font-face {
font-family: 'Montserrat'; font-style: normal; font-weight: 400; font-display: swap; src: url(https://fonts.gstatic.com/s/montserrat/v15/JTUSjIg1_i6t8kCHKm45xW4.ttf) format('truetype');
}
...
<table class="card " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px; width: 100%; overflow: hidden; border: 1px solid transparent;" bgcolor="transparent">
  <tbody>
    <tr>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
          <h1 style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px; font-family: 'Exo 2', sans-serif;" align="left">${title}</h1>
          <h5 class="text-muted " style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72; font-family: 'Exo 2', sans-serif;" align="left">Em anexo, segue .pdf extraído do Clockify, referente ao período de ${startDate} até ${endDate}.</h5>
  ...
  <tbody>
    <tr>
      <td height="8" style="border-spacing: 0px; border-collapse: collapse; line-height: 8px; font-size: 8px; width: 100%; height: 8px; margin: 0;" align="left">
          ...
          <h6 class="text-muted " style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 16px; line-height: 19.2px; color: #636c72; font-family: 'Exo 2', sans-serif;" align="left">Este é um relatório automático, caso perceba alguma inconsistência nos dados do Clockify, <a href="mailto:${senderEmail}">responda esse e-mail</a> e corrigirei prontamente.</h6>
<table class="s-2 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
      <td height="8" style="border-spacing: 0px; border-collapse: collapse; line-height: 8px; font-size: 8px; width: 100%; height: 8px; margin: 0;" align="left">
...
<table class="s-5 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
        <div>
        <table class="row g-0" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin-right: -15px; margin-left: -15px; table-layout: fixed; width: 100%;">
  <thead>
    <tr>

          <th class="col-md-4" align="left" valign="top" style="line-height: 24px; font-size: 16px; margin: 0;">

            <img src="https://www.grupoorion.com.br/wp-content/themes/orion/images/politicaDePrivacidade/logoOrion.png" class="logo-orion" alt="logo-orion" style="height: auto; line-height: 100%; outline: none; text-decoration: none; margin-top: 1.4em; margin-left: 1.1em; margin-right: 1.1em; width: 150px; border: 0 none;">
            <img src="https://www.grupoorion.com.br/wp-content/themes/orion/images/politicaDePrivacidade/cadavezmaisconectado.png" class="logo-orion" alt="logo-orion-conectados" style="height: auto; line-height: 100%; outline: none; text-decoration: none; margin-top: 1.4em; margin-left: 1.1em; margin-right: 1.1em; width: 150px; border: 0 none;">

</th>

          <th class="col-md-8" align="left" valign="top" style="line-height: 24px; font-size: 16px; margin: 0;">
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
              <h5 class="card-title" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; font-family: 'Exo 2', sans-serif;" align="left">Hugo Fonseca</h5>
              <p class="card-text" style="line-height: 24px; font-size: 16px; width: 100%; font-family: 'Montserrat', sans-serif; margin: 0;" align="left">Desenvolvedor de software</p>
              <p class="text-muted m-0" style="line-height: 24px; font-size: 16px; width: 100%; color: #636c72; font-family: 'Montserrat', sans-serif; margin: 0;" align="left">hugo.fonseca@grupoorion.com.br</p>
              <p class="text-muted m-0" style="line-height: 24px; font-size: 16px; width: 100%; color: #636c72; font-family: 'Montserrat', sans-serif; margin: 0;" align="left">+55 (61) 99110-1515</p>
              <p class="card-text" style="line-height: 24px; font-size: 16px; width: 100%; font-family: 'Montserrat', sans-serif; margin: 0;" align="left"><a target="_blank" href="https://www.grupoorion.com.br/"><small class="text-muted" style="color: #636c72;">www.grupoorion.com.br</small></a></p>
            </div>
      </td>
    </tr>
  </tbody>
            ...
            <div class="card-footer" style="background-color: transparent; border: transparent;">
              <table class="btn m-2" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center">
        <a href="https://www.github.com/Hugo-NF" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; padding: 8px 12px; border: 1px solid transparent;">
                <img src="https://cdn0.iconfinder.com/data/icons/octicons/1024/mark-github-24.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
              </a>
      </td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center">
        <a href="https://www.linkedin.com/in/hugo-fonseca-723a41184/" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; padding: 8px 12px; border: 1px solid transparent;">
                <img src="https://cdn2.iconfinder.com/data/icons/social-media-2285/512/1_Linkedin_unofficial_colored_svg-24.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
              </a>
      </td>
    </tr>
  </tbody>
